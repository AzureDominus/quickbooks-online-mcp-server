...
const toolSchema = z.object({
  ...
  accountType: z
    ...
    .optional()
    .describe(
      "Filter by account type (e.g., 'Bank', 'Expense', 'Income', 'Other Current Asset', 'Fixed Asset', 'Other Current Liability', 'Long Term Liability', 'Equity', 'Cost of Goods Sold', 'Other Income', 'Other Expense')"
    ),
  classification: z
    .enum(['Asset', 'Liability', 'Equity', 'Revenue', 'Expense'])
    .optional()
    .describe('Filter by account classification'),
  balanceMin: z.number().optional().describe('Minimum current balance'),
  balanceMax: z.number().optional().describe('Maximum current balance'),
